...
('admin-123', 'admin@studentforge.com', '$2b$10$hI71AvxtsGF7J1WTt1kWiu1iIHAenK6KWsR19nnPbPi.Ic3xHgAWC', 'Admin User', 'ADMIN', now(), now()),
('instructor-123', 'instructor@studentforge.com', '$2b$10$hI71AvxtsGF7J1WTt1kWiu1iIHAenK6KWsR19nnPbPi.Ic3xHgAWC', 'John Instructor', 'INSTRUCTOR', now(), now()),
('student1-123', 'student1@studentforge.com', '$2b$10$hI71AvxtsGF7J1WTt1kWiu1iIHAenK6KWsR19nnPbPi.Ic3xHgAWC', 'Alice Student', 'STUDENT', now(), now()),
('student2-123', 'student2@studentforge.com', '$2b$10$hI71AvxtsGF7J1WTt1kWiu1iIHAenK6KWsR19nnPbPi.Ic3xHgAWC', 'Bob Student', 'STUDENT', now(), now());
